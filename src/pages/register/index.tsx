...
function RegisterFrom() {
    ...
    return (
        <RootLayout>
            <div className="font-fontTH01 max-w-2xl mx-auto bg-white mt-10 p-12 w-[300px] sm:w-12 md:w-6/12 lg:w-6/12 2xl:w-5/12  px-6 py-10 sm:px-10 sm:py-6  rounded-lg shadow-md lg:shadow-lg">
                <h2 className="text-lg font-semibold text-1xl lg:text-3xl text-gray-800 my-5">
                    สมัครสมาชิก
                </h2>
                <form className="mt-10 " method="POST" onSubmit={handleSubmit}>
                    <div className=" top-[100px] flex gap-6 mb-6 lg:grid-cols-2">
                        <div className='w-[50%]'>
                            <label htmlFor="first_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">ชื่อ</label>
                            <input type="text"
                                value={fname}
                        ...
                        <div className='w-[50%]'>
                            <label htmlFor="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">นามสกุล</label>
                            <input type="text"
                                value={lname}
                                onChange={(e) => setLname(e.target.value)} id="last_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="กรูณากรอกนามสกุล" pattern="^[A-Za-zก-๙\s]*$" title="กรุณากรอกข้อมูลให้ถูกต้อง" required />
                        </div>
                    ...
                    <div className="mb-6 my-5">
                        ...
                        <input type="number"
                            value={tel}
                            onChange={(e) => setTel(e.target.value)} id="phone" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" title="กรุณากรอกเบอร์โทรเป็นตัวเลขเท่านั้น" required />
                    </div>
                    <div>
                        <label htmlFor="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">วัน/เดือน/ปี เกิด</label>
                        <input type="date"
                            value={birthday}
                            onChange={(e) => setBirthday(e.target.value)} id="website" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                    </div>
                    <div className="mb-6 my-5">
                    ...
                    <div>
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                id="confirm_password"
                                className={`bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${passwordsMatch ? '' : 'border-red-500'}`}
                                placeholder="•••••••••"
                                required
                            />
                            {!passwordsMatch && <p className="text-red-500">กรุณากรอกรหัสผ่านให้ถูกต้อง</p>}
                        </div>
                        <div className="mb-2">
                ...
                <div className="sm:flex sm:flex-wrap mt-8 sm:mb-4 text-sm text-center justify-center ">
                    ...
                    <Link className="mx-3 " href="./login">
                        <p className="flex-2 underline mx-2 text-blue-700">
                            เข้าสู่ระบบ
                        </p>
                    </Link>
