...
export default function Modal({ onSubmit }: any) {
    ...
    return (
        <>
            <button onClick={() => setOpen(!openSubmit)}  className="w-[200px] py-3 bg-[#FFCD4B] rounded-lg font-medium text-white uppercase focus:outline-none hover:bg-gray-700 hover:shadow-none">
                จองคิว
            </button>
            ...
            {/* <div className="flex justify-center mt-6">
                <button
                    type="submit"
                    disabled={loading}
                    onClick={() => setIsModalOpen(true)} // เมื่อคลิกที่ปุ่ม "จองคิว" ให้เปิด Modal
                                ...
                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                    ...
                                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                        ...
                                        <button
                                            ...
                                            onClick={() => setOpen(!open)} // Close the modal on button click
                                            ref={cancelButtonRef}
                                        >
                                            ยกเลิก
                                        </button>
