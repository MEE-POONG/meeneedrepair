            ...
            >
                <div>
                    <img
                        ...
                        src={`https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${newsData.img}/public`} alt={newsData.img} />
                    
                    <div className="mt-8 mx-4 xl:mx-0">
                        <h4 className="text-xl md:text-4xl font-semibold text-white">{newsData.title}</h4>
                        ...
                        <div className="col-span-7 bg-[#F4F5F5] mt-10 rounded-lg">
                            <div className="py-16">
                                ...
                                <article className="prose lg:prose-md md:mx-auto mt-8 px-2 md:px-0">
                                    <h1 className=" text-xl md:text-2xl">{newsData.subtitle}</h1>
                                    <p>
                                    {newsData.detail}
                                    </p>
