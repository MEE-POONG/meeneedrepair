...
//             <img src="/images/imgslider/111.jpg" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
//           </div>
//           {/* Item 2 */}
//           <div className={` ${activeSlide === 1 ? '' : 'opacity-0'}`} data-carousel-item>
//             <img src="/img/imgslider/school2.png" className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
//           </div>
//           {/* Item 3 */}
...
//           <button
//             type="button"
//             className={`w-3 h-3 rounded-full ${activeSlide === 2 ? 'bg-blue-500' : 'bg-gray-300'}`}
...
//           <button
//             type="button"
//             className={`w-3 h-3 rounded-full ${activeSlide === 3 ? 'bg-blue-500' : 'bg-gray-300'}`}
...
//           <button
//             type="button"
//             className={`w-3 h-3 rounded-full ${activeSlide === 4 ? 'bg-blue-500' : 'bg-gray-300'}`}
...
//         </div>
//         {/* Slider controls */}
//         <button type="button" className="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev onClick={handlePrevSlide}>
...
//           </span>
//         </button>
//         <button type="button" className="absolute top-0 right-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next onClick={handleNextSlide}>
//           <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
//             <svg className="w-4 h-4 text-white dark:text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
