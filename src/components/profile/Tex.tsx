...
export default function Tex() {
    ...
    const [taxinvoiceData, setTaxinvoiceData] = useState<any>({}); // กำหนดประเภทของข้อมูลบทความข่าว
    ...
    useEffect(() => {
        if (id) {
            fetch(`/api/taxinvoice/${id}`)
                .then((response) => response.json())
                .then((data) => {
                    setTaxinvoiceData(data); // กำหนดข้อมูลบทความข่าวที่ดึงมา
                    //console.log(data);
            ...
            <div className="mt-10">
                ...
                <div className="mt-5 leading-loose">
                    <p>
                        ...
                        {/* {taxinvoiceData.fname} {taxinvoiceData.lname} */}
                    </p>
                    <p>
