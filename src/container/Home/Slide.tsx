            ...
            <div className=''>
                ...
                > {blogData.slice(0, visibleItems).map((blog) => (
                    <SwiperSlide className="relative">
                        ...
                        <img  className="object-cover w-full min-h-full" src={`https://imagedelivery.net/QZ6TuL-3r02W7wQjQrv5DA/${blog.img ? blog.img : 'f701ce08-7ebe-4af2-c4ec-2b3967392900'}/public`} alt="img1" />
                        </Link>
                    </SwiperSlide>
                ))}
                </Swiper>
