    ...
    return (
      <div className="flex items-center justify-center  bg-gradient-to-br">
        <div className="p-4 items-center justify-center w-[680px] rounded-xl group sm:flex space-x-6 bg-white bg-opacity-50 shadow-xl hover:rounded-2xl">
          <img
            src="../images/LOGO.png"
            className=" w-[200px] mx-auto block  rounded-lg"
            alt=""
          />
          <div className="sm:w-8/12 pl-0 p-5 space-y-2">
              <h4 className="text-md font-semibold text-cyan-900 text-justify">
                ทำความรู้จัก
              </h4>
              <div className="flex items-center space-x-4 justify-between">
                <div className="flex gap-3 space-y-1">
                  <span className="text-3xl ">MEED NEED repair</span>
                </div>
              ...
              <div className=" space-x-1 ">
                <div className=" bg-cyan-400 shadow-lg shadow- shadow-cyan-400 text-white w-[150px] cursor-pointer px-3 text-center justify-center items-center py-1 rounded-xl flex space-x-2 flex-row">
                  <span>เพิ่มเติม</span>
                </div>
              </div>
              </a>
